...
# Extra Material 
Several videos testing the architecture are recorded and present through [`Media`](https://drive.google.com/file/d/1wLJwq8hGhBpHKh4v2OiO7iuZHSlS__et/view?usp=sharing). In addition, a presentation illustrating the whole process is present thoug [`Final_Presentation.ppsx`](https://drive.google.com/file/d/1m-NzvAla1AFsKfQxQ9sJvkQg49en9b6q/view?usp=sharing).
